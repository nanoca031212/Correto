...
export default {
  ...
  data() {
    return {
      ...
      leads: [
        { id: 1,  name: 'Ana Paula Souza',  email: 'ana.paula@email.com',        phone: '(45) 99801-2345', interest: '2 quartos',     source: 'Facebook Ads', status: 'Novo',        message: 'Tenho interesse em um apartamento de 2 quartos, de preferência no andar alto.' },
        { id: 2,  name: 'Marcos Vinícius',  email: 'marcos.v@gmail.com',         phone: '(45) 98822-6789', interest: '3 quartos',     source: 'Instagram',    status: 'Contatado',   message: 'Vi o anúncio no Instagram, quero saber mais sobre os 3 quartos.' },
        { id: 3,  name: 'Fernanda Lima',    email: 'fernanda.lima@outlook.com',  phone: '(45) 99733-4321', interest: 'Cobertura',     source: 'Google Ads',   status: 'Contatado',   message: 'Procuro uma cobertura duplex. Já visitei o estande. Aguardando proposta.' },
        { id: 4,  name: 'Ricardo Alves',    email: 'ricardoalves@yahoo.com.br',  phone: '(45) 99644-8765', interest: '2 quartos',     source: 'Facebook Ads', status: 'Novo',        message: null },
        { id: 5,  name: 'Juliana Prado',    email: 'ju.prado@gmail.com',         phone: '(45) 99555-0011', interest: 'Área de lazer', source: 'Site direto',  status: 'Perdido',     message: 'Tive interesse mas vou aguardar próximo lançamento.' },
        { id: 6,  name: 'Carlos Henrique',  email: 'carlos.h@empresa.com.br',    phone: '(44) 98811-2200', interest: '3 quartos',     source: 'Instagram',    status: 'Qualificado', message: 'Quero um apartamento de 3 quartos para investimento.' },
        { id: 7,  name: 'Patrícia Mendes',  email: 'patricia.mendes@gmail.com',  phone: '(45) 99900-7788', interest: 'Cobertura',     source: 'Google Ads',   status: 'Contatado',   message: null },
        { id: 8,  name: 'Bruno Ferreira',   email: 'brunoferr@hotmail.com',      phone: '(45) 98833-5544', interest: '2 quartos',     source: 'Facebook Ads', status: 'Novo',        message: 'Me enviou mensagem pelo WhatsApp após ver o anúncio.' },
        { id: 9,  name: 'Larissa Costa',    email: 'larissa.costa@icloud.com',   phone: '(45) 99767-3322', interest: '1 quarto',      source: 'Site direto',  status: 'Qualificado', message: 'Preciso de um apartamento studio ou 1 quarto, para uso próprio.' },
        { id: 10, name: 'Diego Santos',     email: 'diegosantos@gmail.com',      phone: '(45) 98899-6655', interest: '3 quartos',     source: 'Instagram',    status: 'Novo',        message: null },
      ],
      scope: [
