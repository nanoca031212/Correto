...
export default {
  ...
  methods: {
    initScene() {
      ...
      // So permite girar arrastando/clicando - sem zoom (roda do mouse)
      // nem pan, pra nao mudar o tamanho/enquadramento do globo e nao
      // "sequestrar" o scroll normal da pagina.
      controls.enablePan = false;
      controls.enableZoom = false;
      controls.enableRotate = true;
      // Trava o angulo vertical pra nao deixar a camera passar por cima
      // dos polos - isso deixava o globo com uma visao estranha, meio
      // cortada em cima/embaixo, quando arrastava demais na vertical.
