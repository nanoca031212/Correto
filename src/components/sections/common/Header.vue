  ...
  >
      ...
      <div class="header-content">
        ...
        <nav class="nav-desktop">
          <ul class="nav-list">
            ...
            <li><a href="#panoramica" class="nav-link" @click="scrollToSection('panoramica')">Vista Panorâmica</a></li>
    ...
    >
      ...
      <ul class="mobile-nav-list">
        ...
        <li>
          <a href="#panoramica" @click="handleMobileNavClick('panoramica')" class="mobile-nav-link">
            Vista Panorâmica
          </a>
        </li>
        <li>
...
export default {
  ...
  setup() {
    ...
    const { showHeader, isScrolled } = useScrollHeaderState()

    const isMobileMenuOpen = ref(false)
    // Só liga a transição depois do primeiro paint, senão o header já
    // nasceria visível e a animação de entrada nunca dispararia
    const justMounted = ref(false)
    const headerVisible = computed(() => justMounted.value && showHeader.value)
...
.header {
  ...
  /* Estado escondido: usado tanto antes do 1º paint (entrada ao carregar)
     quanto ao scrollar para baixo - mesma transição para os dois casos */
  opacity: 0;
...
/* Mobile: logo centralizado e menor, hamburguer fica à direita */
